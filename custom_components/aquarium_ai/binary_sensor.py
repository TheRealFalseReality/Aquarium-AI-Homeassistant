...
async def async_setup_entry(
    ...
    # Create analysis available binary sensor
    entities.append(
...
class AquariumAIAnalysisAvailable(BinarySensorEntity):
    """Binary sensor for analysis availability status."""
    ...
    def __init__(
        ...
        self._attr_name = f"{tank_name} Analysis Available"
        self._attr_unique_id = f"{config_entry.entry_id}_analysis_available"
    ...
    @property
    def is_on(self) -> bool:
        """Return true if analysis is available."""
        return self._state
    ...
    async def async_update(self) -> None:
        ...
        try:
            ...
            if sensor_analysis and last_update:
                ...
                # Add attributes with the last updated timestamp
                self._attr_extra_state_attributes = {
